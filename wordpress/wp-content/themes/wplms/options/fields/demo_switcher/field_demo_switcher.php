...
class VIBE_Options_demo_switcher extends VIBE_Options{	
	...
	*/
	function render(){
		$ele_templates_not_available = array('default','demo12','demo_4','demo_4_academy','instructor','school','learningcenter','demo13','demo14','demo15','demo16','demo17','onecourse','oneinstructor','points_system','childone');
