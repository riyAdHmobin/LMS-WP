		...
		<div id='evo_health_details' class='evo_edit_field_box Xevo_metabox_secondary evo_meta_elements' style='display:<?php echo $EVENT->check_yn('_health')?'block':'none';?>'>
			...
			echo EVO()->elements->process_multiple_elements(
				array(
					array(
						'type'=>'notice',
						'name'=> __('Use the below fields to provide health guidelines regarding this event to attendees. Health guidelines field must be enabled via eventON settings > EventCard Data to display this on eventcard.', 'eventon'),						
					),array(
						'type'=>'yesno_btn',
