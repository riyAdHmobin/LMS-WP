<?php
 ...
 class VibeBP_Group_Type_Settings{
    ...
    public function __construct(){
        $this->bp_group_type_synced = get_option('bp_group_type_synced');
        ...
        if(empty($this->bp_group_type_synced)){
    ...
    function check_migration(){
        ...
        if(!empty($_GET['taxonomy']) && $_GET['taxonomy']=='bp_group_type'  && !empty($_GET['migrate_vibebp'])){
            update_option('bp_group_type_synced',1);
        }
    }
    ...
    function show(){
        ...
        if(defined('BP_VERSION') && version_compare( BP_VERSION, '7.1', '>=' )){
            if(!empty($this->bp_group_type_synced)){
                echo '<p>'._x('You have migrated to buddypress group type panel','','vibebp').'</p>';
                echo '<a href="'.admin_url('edit-tags.php?taxonomy=bp_group_type').'" class="button is-primary  " >'._x('Goto buddypress panel','','vibebp').'</a>';
                return;
            }else{
                echo '<a href="'.admin_url('edit-tags.php?taxonomy=bp_group_type&migrate_vibebp=1').'" class="button button-primary" style="margin-bottom:50px;">'._x('Migrate to buddypress panel','','vibebp').'</a>';
            }
        }
