                ...
                if(!empty($attachment_id)){
                  if(is_array($attachment_id)){
                    foreach($attachment_id as $attachid){
                      ...
                      echo '<div class="download_attachment"><a href="'.$url.'" target="_blank" download="'.filename($url).'"><i class="icon-download-3"></i> '.__('Download Attachment','wplms-assignments').'</a></div>';
                    }
                  }else{
